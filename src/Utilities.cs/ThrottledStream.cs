...
{
    // Source https://gist.github.com/passy/637319
    /// <summary>
    ...
    public class ThrottledStream : Stream
    {
        ...
        new public async Task<int> ReadAsync(byte[] buffer, int offset, int count)
        {
        ...
        new public async Task WriteAsync(byte[] buffer, int offset, int count)
        {
            await ThrottleAsync(count);
